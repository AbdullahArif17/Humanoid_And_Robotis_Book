...
1.  **Launch Nav2**: In a terminal (often inside the same Docker container as your other ROS nodes), you would run a ROS 2 launch file to start the Nav2 stack. This launches a number of nodes responsible for planning, localization, and control.
